...
class SosopoTest(unittest.TestCase):
    ...
    def test_openai_compatible_ai_provider_configuration_is_secret_safe(self) -> None:
        ...
        try:
            ...
            self.assertEqual(self.server.available_ai_providers(), [{"name": "OpenAI", "model": "test-model", "models": self.server.AI_PROVIDER_MODELS["OpenAI"], "source": "instance"}])
        finally:
    ...
    def test_database_ai_provider_settings_override_environment(self) -> None:
        ...
        self.assertEqual(s.available_ai_providers(), [{"name": "OpenAI", "model": "stored-model", "models": s.AI_PROVIDER_MODELS["OpenAI"], "source": "instance"}])
